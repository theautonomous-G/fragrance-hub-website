  ...
  const posts = [
    {
      ...
      excerpt:
        'Finding the perfect fragrance is a journey of self-discovery. Learn how to navigate the molecular landscape of perfumery.',
      image:
    ...
    },
    {
      ...
      excerpt:
        'Concentration matters. Understand the science behind fragrance longevity and projection.',
      image:
    ...
    },
    {
      ...
      excerpt:
        'Command presence in the boardroom with these expertly curated molecular prescriptions.',
      image:
          ...
          {posts.map((post) => (
            ...
            >
              ...
              <div className="p-8 space-y-4">
                ...
                {/* TITLE */}
                <h2 className="text-2xl font-serif group-hover:text-luxury-gold transition-colors">
                  {post.title}
                </h2>
